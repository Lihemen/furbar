        ...
        <div className='space-y-6'>
          ...
          <div className='flex flex-wrap gap-2 place-items-start'>
            <Group className='gap-0 justify-center'>
              <button
                className='py-3 w-12 text-white text-center bg-[#494949] rounded-l'
                onClick={() =>
                  setQty((prev) => {
                    if (prev === 1) return 1;
                    return prev - 1;
              ...
              />
              <button
                className='py-3 w-12 text-white text-center bg-[#494949] rounded-r'
                onClick={() => setQty((prev) => prev + 1)}>
                +
              </button>
            </Group>
            <button className='py-3 px-5 uppercase tracking-wider  text-white text-center bg-[#494949] rounded hover:bg-brand-yellow duration-300'>
              Add To Cart
            </button>
